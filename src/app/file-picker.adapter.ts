...
export class DemoFilePickerAdapter extends FilePickerAdapter {
  ...
  public uploadFile(fileItem: FilePreviewModel) {
    ...
    .pipe(
      map( (res: HttpEvent<any>) => {
          ...
          this._butler.uploaderImages.push('https://www.buckapi.us/api/server/local-storage/tixsImages/'+res.body.result.files.file[0].name);
  ...
  public removeFile(fileItem: any): Observable<any> {
    ...
    const removeApi = 'https://db.buckapi.us/api/containers/tixsImages/' + fileItem.id;
